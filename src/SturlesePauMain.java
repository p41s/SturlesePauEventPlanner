...
public class SturlesePauMain {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("[4] Marcar/desmarcar tarea de u1n evento como completado (INCOMPLETO)");
            ...
            switch (option) {
                ...
                case 2:
                    System.out.println("[2] Borrar evento");
                    System.out.print("\nIntroduce el titulo del evento a eliminar:");
                    String eventoABorrar = scanner.nextLine();

                    //Buscar el evento en nuestra lista
                    boolean eventoEncontrado = false;
                    for (int i = 0; i < eventos.size(); i++) {
                        SturlesePauEvent evento = eventos.get(i);
                        if (evento.getTitle().equals(eventoABorrar)) {
                            eventos.remove(i);
                            System.out.println("\nEvento " + eventoABorrar + " eliminado!");
                            eventoEncontrado = true;
                            break;
                        }
                    }
                    if (!eventoEncontrado) {
                        System.out.println("\nNo se ha encontrado ningun evento con este nombre");
                    }
